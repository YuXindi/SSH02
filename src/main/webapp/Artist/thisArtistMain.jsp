    ...
    <div class="left" style="width:59.85%;">
			...
			<div class="artist_info">
				...
				<table border="0" style="margin-left:200px;margin-top:50px;">
					<tr>
						<td rowspan="4" style="width:220px;"><img src="<s:property value="#session.Artphoto1"/>" style="width:160px; height:160px;"/></td>
						
						<td style="font-size:20px; color:#999; ">艺人名：<s:property value="#session.Artname1"/></td>
					</tr>
					<tr>
						<td style="font-size:20px; color:#999; ">歌手类型：<s:property value="#session.Identity1"/></td>
					</tr>
					<tr>
						<td style="font-size:20px; color:#999; ">歌曲流派风格：<s:property value="#session.Style1"/></td>
					</tr>
					<tr>
						<td style="font-size:20px; color:#999; ">艺人简介：<s:property value="#session.Artins1"/></td>
					</tr>					
				</table>
			</div>
			<div class="artist_work">
			    ...
			    <table class="listtablee"  style="font-size: 12px; margin-left:100px;" border="1" bordercolor="#DDD" cellspacing="0">
	    	      ...
	    	      song_lists=(ArrayList)session.getAttribute("listA");     	     
	        ...
	        %>
	              ...
	              <td><div class="like_be">
	              					...
	              					<a href="delete_myfavorite?favorite=<%=name%>&zszl=7" title="删除"><div class="heart1"></div></a>
	                 </div>
	              ...
	              <%}else{ %>
	               <td><div class="like_be">
	              					<div class="ss"><%=len_time%></div>
	              					<a href="insert_favorite_song?songname=<%=name%>&zszl=7" title="收藏"><div class="heart"></div></a>
