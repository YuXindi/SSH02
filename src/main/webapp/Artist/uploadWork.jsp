...
<html>
  ...
  <div class="top">
    ...
    <div class="navigation">
      <ul>
        <li><a href="My_user/main.jsp">我的音乐</a></li>
  ...
  <div class="main" style="z-index:0;">
    ...
    <div class="left" style="width:59.85%;">
		...
		<form  action="uploadWork" method="post" enctype="multipart/form-data"  onsubmit="return checkUp()">
		    <div class="kind" style="height:60px;"><br />&nbsp;&nbsp;&nbsp;&nbsp;
	        	<span style="font-size:25px;">上传我的作品</span>
	        </div>	
			<table  border="0" style="margin-left:200px;margin-top:50px;" >
				<tr style="height:60px;">		
					<td style="width:10px;">歌曲标题：</td>
					<td ><input type="text" name="sl.name"  id="name" onfocus="showTips('nameError','请输入与上传文件名相同的歌曲标题!')"  onblur="nameC()">
					<br/><span class="error" id="nameError"></span></td>					
				</tr>
				<tr style="height:60px;">		 
					<td>时长：</td>
					<td ><input type="text" name="sl.lenTime"  id="lt" onfocus="showTips('ltError','请输入歌曲时长!')"  onblur="ltC()">
					<br/><span class="error" id="ltError"></span></td>	
				</tr>
				<tr style="height:60px;">		 
					<td>专辑：</td>
					<td ><input type="text" name="sl.album"  id="album" onfocus="showTips('albumError','请输入歌曲所属专辑!')"  onblur="albumC()">
					<br/><span class="error" id="albumError"></span></td>	
				</tr>
				<tr style="height:60px;">		 
					<td>上传文件：</td>
					<td ><input type="file" name="uploadSong"  id="upSong" onfocus="showTips('upSongError','请上传歌曲文件!')"  onblur="upSongC()">
					<br/><span class="error" id="upSongError"></span></td>	
				</tr>	
