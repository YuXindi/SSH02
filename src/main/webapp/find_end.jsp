  ...
  <div class="null_l" style="width:19.85%;"></div>
    <div class="left" style="width:59.85%;">
    	...
    	<div class="recom">
        	...
        	<div class="kind" style="margin-top: 50px;padding-bottom: 20px;"><br />&nbsp;&nbsp;&nbsp;&nbsp;
	            	<span style="font-size:20px;">查询结果</span>&nbsp;&nbsp;&nbsp;&nbsp;
	            </div> 
        	<table style="font-size: 12px;" class="listtablee" border="1" bordercolor="#DDD" cellspacing="0">
    	      ...
    	      song_lists=(ArrayList)session.getAttribute("findList");  
        ...
        %>
              ...
              <td><div class="like_be">
              					...
              					<a href="delete_myfavorite?favorite=<%=name%>&zszl=2" title="删除"><div class="heart1"></div></a>
                 </div>
              ...
              <%}else{ %>
               <td><div class="like_be">
              					<div class="ss"><%=len_time%></div>
              					<a href="insert_favorite_song?songname=<%=name%>&zszl=2" title="收藏"><div class="heart"></div></a>
